...
// tool tip//
	...
	rect.on('mouseover', function(d) {
		div.transition()		
                .duration(200)		
                .style('opacity', .9);
        div	.html('Year: '+(d.x) +' <br> '+'Visa Approved: '  + num_formate(d.y))	
...
var file_loc = ['./data/line_chart_total_visa.csv','./data/stack_bar_data.csv','./data/line_chart_top_5_country.csv'];
